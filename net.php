    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="enter-pass">
                <form action="enter_data.php?cat=net" method="post" autocomplete="off">
                    <h1><?php echo __('add_new_password_h_internet'); ?></h1>
                    <label for="name"><?php echo __('add_new_password_title'); ?></label>
                    <input type="text" id="name" name="name" placeholder="npr. Facebook" required>
...
<?php
    try {
        ...
        $sql = "SELECT * FROM passwords WHERE category = 'net' AND user_id = ? AND is_deleted = 0 ORDER BY id DESC";
