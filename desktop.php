    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="enter-pass">
                ...
                <form action="enter_data.php?cat=desktop<?php echo $token; ?>" method="post" autocomplete="off">
                    <h1><?php echo __('add_new_password_h_desktop'); ?></h1>
...
<?php
    try {
        ...
        $sql = "SELECT * FROM passwords WHERE category = 'desktop' AND user_id = ? AND is_deleted = 0 ORDER BY id DESC";
